 ...
 */
public class RestaurantNames extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedState) {
        ...
        setListAdapter(new ArrayAdapter<String>(getActivity(),
                R.layout.fragment_restaurant_names, RestaurantsActivity.restaurantNames)); // loads the listview with the restaurant names
    }
